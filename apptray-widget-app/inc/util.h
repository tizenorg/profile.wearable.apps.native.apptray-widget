 ...
 */
#ifndef __APP_WIDGET_UTIL_H__
#define __APP_WIDGET_UTIL_H__
...
#define RECENT_APPS_ICON IMAGEDIR"/b_home_screen_recent_icon.png"
#define MORE_APPS_ICON IMAGEDIR"/b_home_screen_more_apps.png"
#define SCHEDULE_ICON IMAGEDIR"/b_home_screen_schedule.png"
#define POPUP_DELETE_ICON IMAGEDIR"/tw_ic_popup_btn_delete.png"
#define POPUP_CHECK_ICON IMAGEDIR"/tw_ic_popup_btn_check.png"

#define W_CALENDAR_APP_ID "org.tizen.w-calendar2"
...
typedef enum {
	...
	FEATURE_NOTI_EDITING = 0x0100,
	FEATURE_HOME_EDITING = 0x0200,
	FEATURE_MOVE_MODULE_DRAGGING = 0x0400,
	FEATURE_ADDVIEWER = 0x0800,
	FEATURE_MAX,
} feature_e;
...
extern void apps_util_launch_main_operation(Evas_Object *win, const char *app_id, const char *name, int pos_x, int pos_y);
...
extern int apps_util_is_factory_binary(void);
